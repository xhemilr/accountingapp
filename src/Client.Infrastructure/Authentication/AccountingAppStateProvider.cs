...
namespace AccountingApp.Client.Infrastructure.Authentication
{
    public class AccountingAppStateProvider : AuthenticationStateProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;

        public AccountingAppStateProvider(
