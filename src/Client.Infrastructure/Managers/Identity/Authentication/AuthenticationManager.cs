using AccountingApp.Shared.Constants.Storage;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await ((AccountingAppStateProvider)_authenticationStateProvider).StateChangedAsync();
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((AccountingAppStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
