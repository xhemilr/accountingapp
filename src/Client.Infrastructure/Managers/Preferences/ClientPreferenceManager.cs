...
namespace AccountingApp.Client.Infrastructure.Managers.Preferences
{
    public class ClientPreferenceManager : IClientPreferenceManager
    {
        ...
        public async Task<MudTheme> GetCurrentThemeAsync()
        {
            ...
            if (preference != null)
            {
                if (preference.IsDarkMode == true) return AccountingAppTheme.DarkTheme;
            }
            return AccountingAppTheme.DefaultTheme;
        }
