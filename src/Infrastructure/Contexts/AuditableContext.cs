...
using AccountingApp.Application.Enums;
...
{
    public abstract class AuditableContext : IdentityDbContext<AccountingAppUser, AccountingAppRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, AccountingAppRoleClaim, IdentityUserToken<string>>
    {
