...
namespace AccountingApp.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<AccountingAppRole> roleManager, AccountingAppRole role, string permission)
        {
