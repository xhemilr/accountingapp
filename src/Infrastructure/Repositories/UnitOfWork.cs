...
namespace AccountingApp.Infrastructure.Repositories
{
    public class UnitOfWork<TId> : IUnitOfWork<TId>
    {
        private readonly ICurrentUserService _currentUserService;
        private readonly AccountingAppContext _dbContext;
        private bool disposed;
        private Hashtable _repositories;
        private readonly IAppCache _cache;

        public UnitOfWork(AccountingAppContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
