...
namespace AccountingApp.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        private readonly SignInManager<AccountingAppUser> _signInManager;
        private readonly IStringLocalizer<IdentityService> _localizer;

        public IdentityService(
            UserManager<AccountingAppUser> userManager, RoleManager<AccountingAppRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<AccountingAppUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(AccountingAppUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(AccountingAppUser user)
        {
