...
using AutoMapper;
using AccountingApp.Application.Exceptions;
...
using AccountingApp.Infrastructure.Specifications;
using Hangfire;
...
namespace AccountingApp.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public async Task<IResult> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            var user = new AccountingAppUser
            {
                Email = request.Email,
        ...
        private async Task<string> SendVerificationEmail(AccountingAppUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "admin@accountingapp.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<AccountingAppUser, object>>
                {
